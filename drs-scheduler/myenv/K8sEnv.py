...
class K8sEnv(core.Env):
	...
	def getState(self):
		...
		node1_state[2] = float('%.2f' % min(node1_state[2] / 400 * 100, 100))
		node2_state[2] = float('%.2f' % min(node2_state[2] / 400 * 100, 100))
		node3_state[2] = float('%.2f' % min(node3_state[2] / 400 * 100, 100))
		node4_state[2] = float('%.2f' % min(node4_state[2] / 400 * 100, 100))
		node1_state[3] = float('%.2f' % min(node1_state[3] / 400 * 100, 100))
		node2_state[3] = float('%.2f' % min(node2_state[3] / 400 * 100, 100))
		node3_state[3] = float('%.2f' % min(node3_state[3] / 400 * 100, 100))
		node4_state[3] = float('%.2f' % min(node4_state[3] / 400 * 100, 100))
